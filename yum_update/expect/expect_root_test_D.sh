...
sleep 10
set timeout -1
expect "# " { send "yum --exclude=kernel* --exclude=kernel-* --enablerepo=remi,epel,remi-php56 --exclude=memcached,mysql-libs --downloadonly update -y > /var/log/yum_auto.log\r" }
sleep 10
